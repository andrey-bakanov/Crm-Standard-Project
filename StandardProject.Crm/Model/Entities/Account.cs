...
namespace StandardProject.Crm.Model
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>
		/// Время последнего обновления поля свертки Открытые сделки.
		/// </summary>
		...
		/// <summary>
		/// Состояние поля свертки Открытые сделки.
		/// </summary>
		...
		/// <summary>
		/// Значение поля Открытый доход в базовой валюте.
		/// </summary>
		...
		/// <summary>
		/// Время последнего обновления поля свертки Открытый доход.
		/// </summary>
		...
		/// <summary>
		/// Состояние поля свертки Открытый доход.
		/// </summary>
		...
		public System.Nullable<StandardProject.Crm.Model.AccountState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((StandardProject.Crm.Model.AccountState)(System.Enum.ToObject(typeof(StandardProject.Crm.Model.AccountState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Выберите область или регион продаж для организации, чтобы организация была назначена правильному представителю. Эти данные также используются при сегментации и анализе.
		/// </summary>
		...
		public System.Collections.Generic.IEnumerable<StandardProject.Crm.Model.Account> Referencedaccount_master_account
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<StandardProject.Crm.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencedaccount_master_account");
				this.SetRelatedEntities<StandardProject.Crm.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<StandardProject.Crm.Model.Account> Referencedaccount_parent_account
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<StandardProject.Crm.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencedaccount_parent_account");
				this.SetRelatedEntities<StandardProject.Crm.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public StandardProject.Crm.Model.Account Referencingaccount_master_account
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public StandardProject.Crm.Model.Account Referencingaccount_parent_account
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencingaccount_parent_account");
				this.SetRelatedEntity<StandardProject.Crm.Model.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public StandardProject.Crm.Model.SystemUser lk_accountbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.SystemUser>("lk_accountbase_createdby", null);
			}
		}
		...
		public StandardProject.Crm.Model.SystemUser lk_accountbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.SystemUser>("lk_accountbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_accountbase_createdonbehalfby");
				this.SetRelatedEntity<StandardProject.Crm.Model.SystemUser>("lk_accountbase_createdonbehalfby", null, value);
		...
		public StandardProject.Crm.Model.SystemUser lk_accountbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.SystemUser>("lk_accountbase_modifiedby", null);
			}
		}
		...
		public StandardProject.Crm.Model.SystemUser lk_accountbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.SystemUser>("lk_accountbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_accountbase_modifiedonbehalfby");
				this.SetRelatedEntity<StandardProject.Crm.Model.SystemUser>("lk_accountbase_modifiedonbehalfby", null, value);
		...
		public StandardProject.Crm.Model.SystemUser system_user_accounts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.SystemUser>("system_user_accounts", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("system_user_accounts");
				this.SetRelatedEntity<StandardProject.Crm.Model.SystemUser>("system_user_accounts", null, value);
		...
		public StandardProject.Crm.Model.SystemUser user_accounts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<StandardProject.Crm.Model.SystemUser>("user_accounts", null);
			}
		}
