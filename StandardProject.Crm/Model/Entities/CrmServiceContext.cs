...
namespace StandardProject.Crm.Model
{
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="StandardProject.Crm.Model.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<StandardProject.Crm.Model.Account> AccountSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<StandardProject.Crm.Model.Account>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="StandardProject.Crm.Model.SystemUser"/> entities.
		/// </summary>
		public System.Linq.IQueryable<StandardProject.Crm.Model.SystemUser> SystemUserSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<StandardProject.Crm.Model.SystemUser>();
			}
		}
	}
